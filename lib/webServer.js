...
const log = Log.getLogger('core:webServer');
...
WebServer.prototype.startModule = function(module, callback) {
  ...
  var webHelper = new WebHelper(module.moduleConfig.path, that._webDefaultContextData, dbFactory);
  that._helpers[name] = webHelper;

  const WebApp = require(module.moduleConfig.path + '/lib/web.js');
